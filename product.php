                        ...
                        echo '<td>
                                <div>';
                                    if(!empty($_SESSION['result'][$i])) {
                                        echo '<a href="controller/ProductsController.php?category=details&pid='.$_SESSION['result'][$i][0].'">
                                        <img src="'.$_SESSION['result'][$i][3].'01.jpg"></a>';
                                    }
                          echo '</div>
                                <div>';
                                    if(!empty($_SESSION['result'][$i])) {
                                        echo '<strong><a href="controller/ProductsController.php?category=details&pid='.$_SESSION['result'][$i][0].'">'.$_SESSION['result'][$i][1].'</a></strong><br/>
