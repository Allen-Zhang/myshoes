...
INSERT INTO `carts` VALUES (1,1,'mysh01010001','Men\'s 8 US',10),(2,1,'mysh01010012','Men\'s 8 US',10),(3,1,'mysh01010011','Men\'s 11 US',3),(4,1,'mysh01010008','Men\'s 8.5 US',3),(5,1,'mysh01010003','	Men\'s 10.5 US',5);
...
CREATE TABLE `order_details` (
  ...
  KEY `order_details_fk_1_idx` (`oid`),
  ...
  CONSTRAINT `order_details_fk_1` FOREIGN KEY (`oid`) REFERENCES `orders` (`oid`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `orders` (
  ...
  `exp_date` datetime NOT NULL COMMENT 'expiration date',
...
-- Dump completed on 2014-03-03 23:40:50
