        ...
        <div>
            ...
            <form action="confirmation.php" method="post">
                ...
                <table border="0" cellspacing="0">
                    ...
                    <tr>
                        <td><input type="text" id="name_on_card" name="name_on_card" required onblur="isNameOnCardOk()"></td>
                        <td><input type="text" id="card_number" name="card_number" maxlength="16" required onblur="isCardNumOk()"></td>
                        <td>
                        ...
                        <td>
                            <input type="submit" name="add_card" value="Add your card" onclick="return checkPaymentForm();">
                        </td>
                    </tr>                
                </table>
            </form>
